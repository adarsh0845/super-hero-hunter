...
function getCharacterList(e){
    ...
    // let PUBLIC_KEY = "119f0de0e66d8a8a826684dd3c87aedc";
    // let PRIVATE_KEY = "69beca81a5c9dad931f05a1fd9a4a38155ca62d1";
    ...
    fetch(`https://gateway.marvel.com/v1/public/characters?nameStartsWith=${searchInputTxt}&ts=1687625511840&apikey=119f0de0e66d8a8a826684dd3c87aedc&hash=b60b189437d08f0e6611ee051a165fdc`)
...
function characterModal(heroData){
    ...
    if (comicsName.length > 0) {
        ...
        comicsDiv.innerHTML = "<p>No comics found</>";
    }
}
